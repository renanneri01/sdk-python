...
class Order(MPBase):
    ...
    def process(self, order_id, request_options=None):
        """[Click here for more info](https://www.mercadopago.com/developers/pt/reference/order/online/process-order/post # pylint: disable=line-too-long
        Args:
    ...
    def capture(self, order_id, request_options=None):
        """[Click here for more info](https://www.mercadopago.com/developers/pt/reference/order/online-payments/capture/post)  # pylint: disable=line-too-long
        Args:
    ...
    def create_transaction(self, order_id, transaction_object, request_options=None):
        """[Click here for more info](https://www.mercadopago.com/developers/pt/reference/order/online-payments/add-transaction/post)  # pylint: disable=line-too-long
        ...
        Returns:
            dict: Transaction creation response
        """
        ...
        if response.get("status") != 201:
            raise Exception(f"Failed to create transaction: {response}")
        return response

    def update_transaction(self, order_id, transaction_id, transaction_object, request_options=None):
        """[Click here for more info](https://www.mercadopago.com/developers/pt/reference/order/online-payments/update-transaction/put)  # pylint: disable=line-too-long
